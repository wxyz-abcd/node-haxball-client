...
function createRoom(){
  window.open("./createRoom.html","Create Room","width=800,height=600");
}

function joinRoom(){
  window.open("./joinRoom.html?id="+selectedRoomId,"Join Room","width=800,height=600");
}

function multiJoinRoom(){
  window.open("./multiJoinRoom.html?id="+selectedRoomId,"MultiJoin Room","width=800,height=600");
}
